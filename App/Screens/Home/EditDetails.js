...
export const EditDetails = ({ navigation }) => {
  ...
  return (
    <View style={[Container, { backgroundColor: modalVisible ? 'rgba(0,0,0,0.1)' : '#F2F2F2', }]}>
        ...
        <ParallaxScrollView
                ...
                <View style={imagePencil}>
                  <TouchableOpacity
                    ...
                    <Image
                      ...
                      style={{ height: responsiveHeight(3), width: responsiveHeight(3), resizeMode: 'contain' }}
                    />
                  </TouchableOpacity>
          ...
          <KeyboardAvoidingView
            ...
            <Text
              style={detailExe}>
              i'm giving away a delicious apple cake because i was given two and i
              will not eat both
          </Text>
            <Text
              style={locationText}>
        ...
        <Modal
          ...
          <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.1)' }}>
            <View style={modalContainerTop}>
              <View style={[ApplyButtonText, { marginVertical: responsiveHeight(2) }]}>
                <TouchableOpacity
                  onPress={() => { toggleModal(),navigation.navigate('UpdatePost') }}
                  style={{
                  ...
                  <Text style={{color:COLOR_PRIMARY,fontSize:responsiveFontSize(2.3),fontWeight:'bold'}}>Edit</Text>
                </TouchableOpacity>
              </View>
              <View style={[ApplyButtonText, { marginVertical: responsiveHeight(0.1) }]}>
                <TouchableOpacity
                  onPress={() => { toggleModal(),navigation.navigate('ClosePost') }}
                  style={{
                  ...
                  <Text style={{color:COLOR_PRIMARY,fontSize:responsiveFontSize(2.3),fontWeight:'bold'}}>Close</Text>
                </TouchableOpacity>
              </View>
            </View>
          </View>
